...
if (original.includes('$R1 < 4') && original.includes('Sleep 250') && original.includes('quickTranslateBeforeExtractRetry')) {
...
if (patched.includes(previousQuickTranslateRetryBlock)) {
