...
class DraftControllerTest {
    ...
    void publishDraftReturnsPublishMessage() throws Exception {
        ...
        post.setId(66L);
        post.setStatus(-1);
        java.util.Map<String, Object> publishResult = new java.util.HashMap<>();
        publishResult.put("post", post);
        when(postDraftService.publishDraft(4L, 12L)).thenReturn(publishResult);
